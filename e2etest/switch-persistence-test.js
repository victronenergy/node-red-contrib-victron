...
const { setupFlow, getNodeRedEndpoint, fullRedeploy, setupVrmFixture } = require('./utils.js')
...
test('Dropdown switch value survives a full redeploy restart', async t => {
